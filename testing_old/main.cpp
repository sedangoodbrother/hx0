...
int main(int argc, char* argv[]) {
    ...
    player1.loadTexture("strike_lowhigh", "assets/player_strike_lowhigh.png");
    player1.loadTexture("strike_highlow", "assets/player_strike_highlow.png");
    // player1.loadTexture("hit", "assets/player_hit.png");
    ...
    player2.loadTexture("strike_lowhigh", "assets/player_strike_lowhigh.png");
    player2.loadTexture("strike_highlow", "assets/player_strike_highlow.png");
    // player2.loadTexture("hit", "assets/player_hit.png");
    player2.initializeHurtbox();

    moveset.initialize(player1, player2); 
    ...
    Uint32 frameEnd = frameStart; // Initialize frameEnd to the same value as frameStart

    // Calculate deltaTime
    deltaTime = (frameStart - frameEnd) / 1000.0f; // Convert milliseconds to seconds
    frameEnd = frameStart; // Update frameEnd to the previous frame's start time
    frameStart = SDL_GetTicks(); // Get the current frame's start time
    ...
    while (running) {
        ...
        // Interpret inputs for Player 1
        interpretInputs(player1InputBuffer, moveset.player1SpecialAttacks, 1, player1);
        ...
        // Interpret inputs for Player 2
        interpretInputs(player2InputBuffer, moveset.player2SpecialAttacks, 2, player2);
